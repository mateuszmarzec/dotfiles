...
nnoremap <silent> <leader>sv :<C-U>silent update $MYVIMRC <bar> source $MYVIMRC <bar>
      \ call v:lua.vim.notify(" config successfully reloaded!", 'info', {'title': 'nvim-config'})<cr>
...
nnoremap <C-n> :TreeToggle<CR>
nnoremap <silent><c-t> <Cmd>exe v:count1 . "ToggleTerm"<CR>
inoremap <silent><c-t> <Esc><Cmd>exe v:count1 . "ToggleTerm"<CR>
nnoremap <silent> ZZ :wa <bar> qa<CR>
